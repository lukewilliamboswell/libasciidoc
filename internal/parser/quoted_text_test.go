...
var _ = Describe("quoted texts", func() {
	...
	Context("in final documents", func() {
		...
		Context("with single punctuation", func() {
			...
			It("valid bold text with marker within", func() {
				source := "*some*content*"
				expected := &types.Document{
					Elements: []interface{}{
						&types.Paragraph{
							Elements: []interface{}{
								&types.QuotedText{
									Kind: types.SingleQuoteBold,
									Elements: []interface{}{
										&types.StringElement{Content: "some*content"},
									},
								},
							},
						},
			...
			It("invalid bold text with marker within", func() {
				source := "some*content*"
				expected := &types.Document{
					Elements: []interface{}{
						&types.Paragraph{
			...
			It("valid italic text with marker within", func() {
				source := "_some_content_"
				expected := &types.Document{
					Elements: []interface{}{
						&types.Paragraph{
							Elements: []interface{}{
								&types.QuotedText{
									Kind: types.SingleQuoteItalic,
									Elements: []interface{}{
										&types.StringElement{Content: "some_content"},
									},
								},
							},
						},
			...
			It("invalid italic text with marker within", func() {
				source := "some_content_"
				expected := &types.Document{
					Elements: []interface{}{
						&types.Paragraph{
							Elements: []interface{}{
								&types.StringElement{
									Content: "some_content_",
								},
							},
						},
					},
			...
			It("valid monospace text with marker within", func() {
				source := "`some`content`"
				expected := &types.Document{
					Elements: []interface{}{
						&types.Paragraph{
			...
			It("invalid monospace text with marker within", func() {
				source := "some`content`"
				expected := &types.Document{
					Elements: []interface{}{
						&types.Paragraph{
